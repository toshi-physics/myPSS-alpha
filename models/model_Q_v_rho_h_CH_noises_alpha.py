...
def main():
    ...
    initParser = argparse.ArgumentParser(description='model_Q_v_rho_alpha')
    ...
    # Define vx
    system.create_term("vx", [('iqxQxx', None), ("rho", (np.power, -1))], [alphaxx/gamma, 0, 0, 0])
    system.create_term("vx", [('iqyQxy', None), ("rho", (np.power, -1))], [alphaxx/gamma, 0, 0, 0])
    system.create_term("vx", [('iqxp', None), ("rho", (np.power, -1))], [-1/gamma, 0, 0, 0])
    system.create_term("vx", [('mu', None)], [-1/gamma, 0, 1, 0])
    # Define vy
    system.create_term("vy", [('iqxQxy', None), ("rho", (np.power, -1))], [alphayy/gamma, 0, 0, 0])
    system.create_term("vy", [('iqyQxx', None), ("rho", (np.power, -1))], [-alphayy/gamma, 0, 0, 0])
